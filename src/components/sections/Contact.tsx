		...
		<div
			...
			<motion.form
				...
				<h2 className="text-white font-extrabold text-2xl text-center">
					Onuralp the
					<span className="text-5xl md:text-5xl text-purple-600  ">Developer</span>
				</h2>
				<p className="text-white font-bold md:text-xl my-2 md:m-3 text-center">
					If you are looking for a reliable and skilled web developer to help bring your
					ideas to life, contact me here!
				</p>
				<div className="relative  group  text-green-400">
					...
					<label
						htmlFor="email_from"
						className="absolute transition-all duration-300 bg-stone-800 pointer-events-none text-lg  px-1 h-min left-5 peer-placeholder-shown:text-2xl -top-20  peer-focus:-top-20 peer-focus:text-lg peer-placeholder-shown:-top-6 font-bold my-auto  bottom-0 ">
						E-mail
					</label>
					<p
						className={`${
